...
angular
.module ('eventsProvider', ['underscore', 'chance'])
.service('eventsProvider', ['_', 'chance', function(_, chance)
{
    this.getAll = function()
    {
        return storiaData.events;
    };

    this.getBy = function(id)
    {
        return storiaData.events[id];
    };
    ...
    this.addEvent = function(event)
    {
        ...
        storiaData.events[newId] = { title: event.title, reports: {} };
    };
    ...
    this.addReport = function(eventId, report)
    {
        ...
        event.reports[uuid] = report;
        if (event.previewReportId === undefined)
        {
            event.previewReportId = uuid;
        }
    };
}]);
